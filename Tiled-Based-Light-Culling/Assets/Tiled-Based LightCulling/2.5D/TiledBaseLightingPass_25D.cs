...
class TiledBaseLightingPass_25D : TiledBaseLightingPass
{
    const string CMDSTR = "TiledBaseLightingPass_25D";


    RenderTargetIdentifier lightGrid;

    public TiledBaseLightingPass_25D()
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        cmd.SetComputeTextureParam(cs.LightCullingCS, kernelLightCulling, TiledBaseShaderPropertyId.id_DepthTexture, depthTexture);
        if (isDebug)
        {
